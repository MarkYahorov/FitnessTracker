...
import com.example.core.database.helpers.CreateTableHelper
import javax.inject.Inject

const val FITNESS_DB = "FITNESS.db"
const val VERSION_DB = 1

class FitnessDatabase @Inject constructor(private val context: Context) : SQLiteOpenHelper(context, FITNESS_DB, null, VERSION_DB) {
    ...
    private fun createTrackersTable(db: SQLiteDatabase?) {
        CreateTableHelper()
            ...
            .addField(title = ID_FROM_SERVER, condition = INTEGER_UNIQUE)
